...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "google-api-client", ">= 0.24", "< 0.47"
  ...
  spec.add_development_dependency "simplecov", "~> 0.19.1" # locked due to https://github.com/codeclimate/test-reporter/issues/413
end
