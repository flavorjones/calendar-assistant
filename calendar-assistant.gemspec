...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "simplecov", "~> 0.17.0" # locked due to https://github.com/codeclimate/test-reporter/issues/413
end
