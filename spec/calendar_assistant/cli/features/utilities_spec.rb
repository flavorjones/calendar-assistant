...
RSpec.describe "utility features", :type => :aruba do
  ...
  describe "config" do
    before(:each) { run_command("calendar-assistant config --formatting=false") }
  ...
  describe "version" do
    before(:each) { run_command("calendar-assistant version --formatting=false") }
    before(:each) { stop_all_commands }
  ...
  describe "authorize" do
    before(:each) { run_command("calendar-assistant authorize --formatting=false") }
    before(:each) { stop_all_commands }
  ...
  describe "help" do
    before(:each) { run_command("calendar-assistant help --formatting=false") }
    before(:each) { stop_all_commands }
